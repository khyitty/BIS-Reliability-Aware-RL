"""Create the publication-safe Day-06 seed-linked MAE figure."""
...
SOURCE = ROOT / "reports/journal/day06_concentration_results.csv"
PNG = ROOT / "reports/journal/day06_concentration_mae.png"
PDF = ROOT / "reports/journal/day06_concentration_mae.pdf"
STATES = ("S0", "S_PROP", "S_REMI", "S_CP", "S_CE", "S_CONC")
...
def main() -> None:
    ...
    fig.suptitle("Day 06 concentration anatomy (reconstructed simulation)", y=0.97)
    creator = "deterministic Day06 plotting script"
